...
class CalendarControl:
    ...
    def get_event_list(self, calendarId, timeMin, orderBy, list_func_dict={}):
    ...
    def update_event_name(self, calendarId, eventId, body, update_func_dict={}):
    ...
    def update_event_comment(self, calendarId, eventId, body, update_func_dict={}):
        update_args = self._update_dict(UPDATE_FUNC_ARGUMENT, update_func_dict)
        update_args["calendarId"] = calendarId
        update_args["eventId"] = eventId
        update_args["body"] = body
    ...
    def update_event_starttime_j(self, calendarId, eventId, body, update_func_dict={}):
        update_args = self._update_dict(UPDATE_FUNC_ARGUMENT, update_func_dict)
        update_args["calendarId"] = calendarId
        update_args["eventId"] = eventId
        update_args["body"] = body
    ...
    def update_event_starttime_dm(self, calendarId, eventId, body, update_func_dict={}):
        update_args = self._update_dict(UPDATE_FUNC_ARGUMENT, update_func_dict)
        update_args["calendarId"] = calendarId
        update_args["eventId"] = eventId
        update_args["body"] = body
    ...
    def check_event(self,  body) :
        ...
        events = self.get_event_list(calendarId="primary", timeMin = now, orderBy = "startTime", list_func_dict=list_dict)
        items = events["items"]
        if len(items) == 0:
            return True 
        else:
